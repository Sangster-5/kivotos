...
const ComplaintsPage = () => {
    ...
    return (
        <div style={{ backgroundSize: "auto" }} id='landing-bg'>
            {submitted ? (
                <div className='m-12'>
                    <h1 className='font-bold text-2xl mb-4'>Submitted, we will review your submission</h1>
                    <a href='/' className='border-2 px-4 py-1'>Go Home</a>
                </div>
            ) : (
                <form onSubmit={handleSubmit} method="POST" encType="multipart/form-data" className={"grid px-20 py-10 bg-[#A09D8F] w-3/5 gap-y-4 text-white rounded-md " + p300.className}>
                    ...
                    <div className="grid grid-cols-2">
                        <div>
                            ...
                            <select name="complaintType" id="complaintType" className={"flex flex-row bg-[#868374] text-white rounded-md h-8 px-2 " + r500.className}>
                        ...
                        <div>
                            ...
                            <input className={"flex flex-row file:bg-[#868374] file:border-none file:text-white file:rounded-md file:h-8 file:px-2 text-white " + r500.className} type="file" name="proof" id="proff" />
                        </div>
                    </div>
