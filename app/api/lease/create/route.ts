...
export async function POST(req: NextRequest) {
    ...
    const makeVitalia = () => {
        ...
        //Amenities
        worksheet.getCell("J208").value = "Garbage removal";
        worksheet.getCell("I208").border = thinBorder;
        
        worksheet.getCell("S200").style = {}; worksheet.getCell("S202").style = {}; worksheet.getCell("S204").style = {};

        worksheet.getCell("S198").value = "";  worksheet.getCell("T200").value = "";  worksheet.getCell("T202").value = "";  worksheet.getCell("T204").value = "";
        worksheet.getCell("AA202").style = {}; worksheet.getCell("AA200").style = {}; worksheet.getCell("AA204").style = {};
        worksheet.getCell("AB202").style = {}; worksheet.getCell("AB200").style = {}; worksheet.getCell("AB204").style = {};
        worksheet.getCell("AC202").style = {}; worksheet.getCell("AC200").style = {}; worksheet.getCell("AC204").style = {};
    }

    (data.property != "theArborVictorianLiving") ? makeVitalia() : false;
    ...
    worksheet.getCell("B69").value = application.emergency_contact_phone;

    //Section 8B Lease
    worksheet.getCell("I139").value = getMonthName(data.initialMonth.split("-")[1] as number);
    worksheet.getCell("M139").value = data.initialMonth.split("-")[0];
    worksheet.getCell("I140").value = data.endingDate.split("-")[2];
    worksheet.getCell("M140").value = getMonthName(data.endingDate.split("-")[1]);

    //Section 10 Rent
    worksheet.getCell("K158").value = `$${data.rentPrice}`;

    //Section 15 Security Deposit
    worksheet.getCell("K246").value = `$${data.rentPrice/2}`;
